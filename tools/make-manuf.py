...
file_header = """# This file was generated by running ./tools/make-manuf.py for the rsmanuf library
# 
...
# https://github.com/kkrypt0nn/rsmanuf/blob/main/src/manuf.txt
...
def get_csv(url: str) -> str:
    response = requests.get(
        url=url,
        headers={"User-Agent": "rsmanuf (https://github.com/kkrypt0nn/rsmanuf)"},
    )
